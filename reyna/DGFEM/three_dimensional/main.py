...
class DGFEM:
    ...
    def __init__(self, geometry: DGFEMGeometry, polynomial_degree: int = 1):
        ...
        self.dimension: int = self.geometry.nodes.shape[1]  # TODO: add to DGFEMgeometry `dimension` property.
    ...
    def dgfem(self, solve: bool = True, verbose: int = 0):
        ...
        # TODO: this function is done -- just needed to update the orders calling function.

        assert 0 <= verbose <= 1, '"verbose" must be either 0 or 1.'

        # Generate the basic information for the method, shared by all the methods.
        self.orders = basis_indices(self.polydegree, self.dimension)  # Legendre polynomial orders
    ...
    def _define_boundary_information(self, **kwargs) -> BoundaryInformation:
        ...
        # TODO: this is done -- remains the same, just the boundary_information.py file may need to be changed more.
