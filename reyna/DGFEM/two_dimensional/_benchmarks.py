...
for p in [1, 2, 3]:
    ...
    for n_r in n_elements:
        ...
        l2_error, dg_error, h1_error, dg_error_dict = dg.errors(exact_solution=solution,
                                                                div_advection=lambda x: np.zeros(x.shape[0]),
        ...
        int_norms.append(dg_error_dict['int'])
        int_edges_norms.append(dg_error_dict['int_edges'])
        b_diff_norms.append(dg_error_dict['b_diff'])
        b_adv_norms.append(dg_error_dict['b_adv'])
