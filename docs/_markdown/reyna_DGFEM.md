...
we have the two-dimensional code in place and running as intended. Please click on
...
This solver closely follows the methodology of Cangiani et al. [^1]. I.e. solves 
...
relevant docstrings/documentation.
